...
<div
      className="absolute flex h-[calc(100vh-20rem)] w-full max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
      ...
      <nav className="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
        ...
        <div className="flex flex-grow text-2xl font-medium md:text-5xl md:font-medium text-[#222F3E] justify-items-start ml-4">
            Dashboard
        </div>

        <div className="flex-shrink-0 ">
          <Link href="/signup" className="flex items-center space-x-4 text-right">
            <div className="text-xl font-medium text-[#222F3E]">
