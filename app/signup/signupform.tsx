...
export const SignupForm = () => {
  ...
  return (
    <div className="md:w-1/2 max-w-[700px] text-lg ">
      <h1 className="text-2xl md:text-5xl font-medium text-gray-800 mb-6 font-poppins">Create an account</h1>
 ...
 <div>
  <label htmlFor="confirm-password" className="block text-gray-700 font-light mb-2">
  Confirm password
  </label>
 <div className="relative">
  <input
 ...
 <div onClick={ () => setConfirmPass(!showConfirmPass)} className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 cursor-pointer">
{ showConfirmPass ? <FaEye/> : <FaEyeSlash />}
  ...
  <button
  className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full h-16" type="submit"> Register </button>
 </form>
